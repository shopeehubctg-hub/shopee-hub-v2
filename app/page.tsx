...
export default function Home() {
  ...
  return <main className={`app-shell${sidebarCollapsed?" sidebar-collapsed":""}`}>
    ...
    <section className="workspace">
      ...
      {section==="packages" && <div className="page"><PackageControl storeId={storeId || "all"} storeName={allStoresSelected ? "No Store Selected" : (store?.name ?? "Selected Store")} prefills={packagePrefills} standaloneCreate={standalonePackageCreate} onPrefillsAccepted={()=>setPackagePrefills([])} /></div>}
