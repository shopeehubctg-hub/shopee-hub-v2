  ...
  return <main className="app-shell">
    ...
    <section className="workspace">
      ...
      {section==="overview" && <div className="page">
        <div className="page-title"><div><p className="kicker">OVERVIEW</p><h2>Business pulse</h2></div><div className="warning-pill">{warningOrders.length} important warnings</div></div>
