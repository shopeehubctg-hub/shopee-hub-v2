export const VOUCHER_PRESET_SOURCE = {
  ...
  month:"Latest Avg.",
  metric:"Displayed Sheet Rate",
  updated:"2026-09-23",
};

export const STORE_VOUCHER_PRESETS = {
  "Agepros":{normal:16,campaign:20}, "Berlanco":{normal:14,campaign:19}, "Beyoute":{normal:15,campaign:21},
  "Biotech":{normal:16,campaign:19}, "Bugucare":{normal:16,campaign:22}, "CTG4u":{normal:15,campaign:20},
  "Dr Smile":{normal:10,campaign:20}, "Eco Plus":{normal:18,campaign:26}, "Funffy":{normal:15,campaign:19},
  "GoHerb":{normal:15,campaign:20}, "ISOKAE":{normal:16,campaign:20}, "Jeeroul":{normal:15,campaign:21},
  "Jourish":{normal:14,campaign:15}, "Kata Marine":{normal:15,campaign:20}, "LivAct":{normal:15,campaign:20},
  "M+":{normal:15,campaign:21}, "MCS":{normal:14,campaign:20}, "MFormula":{normal:14,campaign:20},
  "MasterNerv":{normal:15,campaign:23}, "Mizino":{normal:14,campaign:19}, "Mizino Premium":{normal:14,campaign:19},
  "Moesie":{normal:14,campaign:19}, "Ninoko":{normal:14,campaign:23}, "NomoQ":{normal:14,campaign:19},
  "Recovit":{normal:15,campaign:23}, "Scale Gem":{normal:13,campaign:21}, "Scale Story":{normal:14,campaign:21},
  "SkinDae":{normal:15,campaign:20}, "SUPU":{normal:9,campaign:20}, "TGC":{normal:15,campaign:21},
  "URO360":{normal:15,campaign:20}, "YCT Herbal":{normal:14,campaign:20}, "Zeero":{normal:14,campaign:19},
  "iLady":{normal:15,campaign:22},
};
